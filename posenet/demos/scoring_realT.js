...
function findIndex(array32){
  ...
  for(i = 1; i<6; i++){
    if(array32[i]-temp > 0){
      ...
      //console.log(temp);
      //console.log("current array32 at "+i.toString());
      //console.log(array32[i]);
      temp = array32[i];
      index = i;
    }
  }
      ...
      if (score >= minPoseConfidence) {
        if (1) {
          ...
          if(saved_coordinates.length == 40){
            ...
            var predict_score = findIndex(predict_y.dataSync());
            console.log(predict_y.dataSync());
            document.getElementById('scoreLbl').innerHTML = 'Score is '+predict_score.toString();
